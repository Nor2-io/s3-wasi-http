...
impl S3Client {
    ...
    pub fn new_from_env() -> Self {
        ...
        let endpoint = env::var("AWS_ENDPOINT_URL_S3").expect("ENV \"AWS_ENDPOINT_URL_S3\" isn't set");
    ...
    where T: S3ResponseData {
        let resp = 
            self.client.send(request.request).await?;
    ...
    pub fn new_request_builder<T>(&self, request: T) 
        -> Result<S3RequestBuilder<T::ResponseType>>
        where T: S3RequestData, 
    ...
    /// ```
    pub async fn head_object(&self, request: HeadObjectRequest) 
        -> Result<S3Response<HeadObjectResponse>> {
        let req = request.into_builder(
            &self.access_key, 
            &self.secret_key, 
            &self.region, 
            &self.endpoint)?
    ...
    /// }
    /// ```
    pub async fn get_object(&self, request: GetObjectRequest) 
    ...
    /// }
    /// ```
    pub async fn list_buckets(&self, request: ListBucketsRequest) -> Result<S3Response<ListBucketsResponse>> {
        let req = request.into_builder(
            &self.access_key,
            &self.secret_key, 
            &self.region, 
    ...
    /// }
    /// ```
    pub async fn list_objects_v2(&self, request: ListObjectsV2Request) -> Result<S3Response<ListObjectsV2Response>> {
        let req = request.into_builder(
            &self.access_key,
            &self.secret_key, 
            &self.region, 
    ...
    /// assert_eq(resp.status(), StatusCode::OK);
    /// ```
    pub async fn put_object(&self, request: PutObjectRequest) 
